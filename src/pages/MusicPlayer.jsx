...
import Sleep from "../songs/Sunrays.mp3"; // importing the music
...
const MusicPlayer = () => {
    ...
    const [currSong, setSong] = useState(audioFile.songUrl);
    ...
    const changeSong = () => {
      const newSong = getRandoAudioFile();
      setSong(newSong);
    }
    ...
    return (
      <div className="component">
        ...
        <div>
          <button className="playButton" onClick={changeSong}>
