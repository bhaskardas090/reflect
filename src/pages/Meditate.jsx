...
function Meditate() {
  ...
  return (
    <div className={styles.meditateContainer}>
      ...
      <div className={styles.meditationCategory}>
        <MeditationType img={Stress} title="Stress Reduction" desc="Nothing is permanent in this world, not even Stress." />
        <MeditationType img={Devotion} title="Devotion" desc="Devotion is not dissection of life but a total embrace." />
      </div>
      <Navigation /> 
    </div>
  )
